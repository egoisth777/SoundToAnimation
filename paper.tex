...
\subsection{Transformers for Motion}
Transformers have become the backbone of sequence modeling. Recent works like MDM~\cite{tevet2022human} demonstrate their effectiveness for human motion generation. We adapt this paradigm to rigid body dynamics, using cross-attention between audio and motion tokens to capture temporal correlations between sound events and physical trajectories.
